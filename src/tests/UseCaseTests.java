...
public class UseCaseTests {
	...
	public void testScenario(){
		MyCanvasWindow.replayRecording(path + "deletePartySeq/deletePartySeq", canvasWindow);
	}
	 ...
	 */
	@Test
	public void openViewDialogTest(){
		MyCanvasWindow.replayRecording(path + "openDialog/openViewDialog", canvasWindow);
	}
	@Test
	public void openPartyDialogTest(){
		MyCanvasWindow.replayRecording(path + "openDialog/openPartyDialog", canvasWindow);
	}
	@Test
	public void openResultMessageDialogTest(){
		MyCanvasWindow.replayRecording(path + "openDialog/openResultMessageDialog", canvasWindow);
	}
	
	@Test
	public void switchControlsTest(){
		MyCanvasWindow.replayRecording(path + "openDialog/switchControls", canvasWindow);
	}
	@Test
	public void radioSpacebarTest(){
		MyCanvasWindow.replayRecording(path + "openDialog/radioSpacebar", canvasWindow);
	}
	
	/*
	@Test
	public void Test(){
		MyCanvasWindow.replayRecording(path + "/", canvasWindow);
	}
	*/
